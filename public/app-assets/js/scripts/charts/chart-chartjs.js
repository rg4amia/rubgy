...
$(window).on("load", function () {
    ...
    // Chart Data
    var linechartData = {
        labels: ["Jun 10", "Jun 11", "Jun 12", "Jun 13", "Jun 14", "Jun 15", "Jun 16", "Jun 17", "Jun 18", "Jun 19"],
        datasets: [{
            label: "Views",
            data: [86, 114, 106, 106, 107, 111, 133, 221, 783, 28],
            borderColor: $primary,
            fill: false
        }, {
            data: [282, 350, 411, 502, 635, 809, 947, 402, 3700, 267],
            label: "Plays",
            borderColor: $success,
            fill: false
        }, {
            data: [168, 170, 178, 190, 1203, 276, 408, 547, 675, 734],
            label: "Clicks",
            borderColor: $danger,
            fill: false
        }, {
            data: [40, 20, 110, 16, 2524, 38, 74, 167, 508, 784],
            label: "Interactions",
            borderColor: $warning,
            fill: false
        }]
    ...
    var barchartData = {
        ...
        datasets: [{
            label: "Clicks",
            data: [2478, 5267, 734, 784, 433, 278, 1526, 734],
            backgroundColor: $primary,
            borderColor: "transparent"
        }, {
            label: "View",
            data: [478, 267, 1734, 784, 33, 1278, 526, 73],
